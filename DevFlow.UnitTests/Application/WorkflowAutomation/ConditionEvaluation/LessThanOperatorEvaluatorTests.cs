...
{
    public class LessThanOperatorEvaluatorTests
    {
        [Fact]
        public void Should_Return_LessThan_Operator()
        {
            // Arrange
            var converterMock = new Mock<IWorkflowValueConverter>();

            var evaluator = new LessThanOperatorEvaluator(
                converterMock.Object);

            // Assert
            evaluator.Operator.Should().Be(WorkflowOperator.LessThan);
        }
        [Fact]
