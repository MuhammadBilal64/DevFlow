...
{
    public class GreaterThanOrEqualEvaluatorTests
    {
        [Fact]
        public void Should_Return_GreaterThanOrEqual_Operator()
        {
            // Arrange
            var converterMock = new Mock<IWorkflowValueConverter>();

            var evaluator = new GreaterThanOrEqualEvaluator(
                converterMock.Object);

            // Assert
            evaluator.Operator.Should().Be(WorkflowOperator.GreaterThanOrEqual);
        }
        [Fact]
        ...
        [Fact]
        public void Should_Return_False_When_Actual_Value_Is_Less_Than_Expected_Value()
        {
            // Arrange
            var converterMock = new Mock<IWorkflowValueConverter>();
