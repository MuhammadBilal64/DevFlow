...
{
    public class NotEqualOperatorEvaluatorTests
    {
        [Fact]
        public void Should_Return_NotEquals_Operator()
        {
            // Arrange
            var converterMock = new Mock<IWorkflowValueConverter>();

            var evaluator = new NotEqualOperatorEvaluator(
                converterMock.Object);

            // Assert
            evaluator.Operator.Should().Be(WorkflowOperator.NotEquals);
        }

        [Fact]
        public void Should_Return_False_When_Values_Are_Equal()
        {
            // Arrange
            var converterMock = new Mock<IWorkflowValueConverter>();
        ...
        [Fact]
        public void Should_Return_True_When_Values_Are_Not_Equal()
        {
            // Arrange
            var converterMock = new Mock<IWorkflowValueConverter>();
