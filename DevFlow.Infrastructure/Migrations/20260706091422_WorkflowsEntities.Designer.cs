...
namespace DevFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260706091422_WorkflowsEntities")]
    partial class WorkflowsEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevFlow.Domain.Entities.Workflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevFlow.Domain.Entities.WorkflowAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevFlow.Domain.Entities.WorkflowCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevFlow.Domain.Entities.WorkflowAction", b =>
                {
                    b.HasOne("DevFlow.Domain.Entities.Workflow", "Workflow")
                        .WithMany("Actions")
